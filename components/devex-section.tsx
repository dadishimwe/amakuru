...
const STEPS = [
  {
    num: "01",
    title: "Curate",
    desc: "Bring stories together with context",
    file: "terminal",
    lang: "bash",
    code: [
      { type: "comment", text: "# Join the early-access list" },
      { type: "command", text: "subscribe --email you@example.com" },
      { type: "gap" },
      { type: "comment", text: "# Start curating sources" },
      { type: "command", text: "add-source --type local --name \"Rwanda outlet\"" },
      { type: "gap" },
      { type: "output", text: "✓ Source connected" },
      { type: "output", text: "✓ Context overlays enabled" },
      { type: "output", text: "✓ Ready to curate" },
    ],
  },
  {
    num: "02",
    title: "Score",
    desc: "Transparent credibility signals",
    file: "scoring/methodology.json",
    lang: "typescript",
    code: [
      { type: "comment", text: "// scoring/methodology.json (simplified)" },
      { type: "keyword", text: "export", after: " const ", keyword2: "methodology", keyword3: " =", fn: "", args: " {" },
      { type: "gap" },
      { type: "plain", text: "  sources: [\"corrections\", \"citations\", \"history\"]," },
      { type: "gap" },
      { type: "plain", text: "  weights: { citations: 0.45, corrections: 0.35, transparency: 0.20 }," },
      { type: "plain", text: "};" },
    ],
  },
  {
    num: "03",
    title: "Verify",
    desc: "Community proof with tiers",
    file: "verification/tip.schema.ts",
    lang: "typescript",
    code: [
      { type: "comment", text: "// verification/tip.schema.ts (simplified)" },
      { type: "keyword", text: "export", after: " type ", keyword2: "Tip", keyword3: " =", fn: "", args: " {" },
      { type: "gap" },
      { type: "plain", text: "  phoneVerified: boolean;" },
      { type: "plain", text: "  locationTier: 'neighborhood' | 'district' | 'province';" },
      { type: "plain", text: "  expertise?: 'farmer' | 'driver' | 'health' | 'teacher';" },
      { type: "plain", text: "  evidence?: 'photo' | 'audio' | 'link';" },
      { type: "gap" },
      { type: "plain", text: "};" },
    ],
  },
  {
    num: "04",
    title: "Listen",
    desc: "Audio-first summaries",
    file: "terminal",
    lang: "bash",
    code: [
      { type: "comment", text: "# Generate audio summaries" },
      { type: "command", text: "summarize --top 10 --lang rw --format audio" },
      { type: "gap" },
      { type: "output", text: "  Selecting top stories..." },
      { type: "output", text: "  Producing Kinyarwanda audio..." },
      { type: "output", text: "  Publishing to podcast feed..." },
      { type: "gap" },
      { type: "success", text: "✓ audio summaries ready" },
      { type: "url", text: "  → https://amakuru.rw/listen" },
    ],
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Built for Rwanda.<br />Useful for everyone.
          </h2>
        </div>
