...
const AGENTS = [
  {
    label: "CURATION",
    title: "Context-first aggregation",
    desc: "When global outlets cover Rwanda and the region, Amakuru adds local context sidebars and points you to primary sources.",
    stats: [{ v: "Kinyarwanda", l: "first-class" }, { v: "3", l: "languages" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "VERIFICATION",
    title: "Community proof, not vibes",
    desc: "Phone-verified contributions with location tiers (neighborhood → district → province) and evidence-first verification.",
    stats: [{ v: "Tiers", l: "location trust" }, { v: "Badges", l: "expertise" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "JOURNALISTS",
    title: "Grow the next newsroom",
    desc: "A contributor pipeline with micro-payments for verified tips and beat badges (tech, agriculture, policy) to build portfolios.",
    stats: [{ v: "Tips", l: "to stories" }, { v: "Beats", l: "specialize" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "AUDIO",
    title: "Radio-native summaries",
    desc: "Audio summaries of top stories, voice-based contributions, and podcast partnerships — designed for how Rwanda consumes news.",
    stats: [{ v: "Audio", l: "top stories" }, { v: "Voice", l: "contributions" }],
